...
csvImport.directive('ngCsvImport', function (Base) {
    return {
        restrict: 'E',
        transclude: true,
        replace: true,
        ...
        template: function (element, attrs) {
            ...
            return '<div>' +
                    ...
                    '</div>' +
                    '' +
                    '<input class="form-control" ng-disabled="desactiver" upload-button-label="{{uploadButtonLabel}}" type="file" ' + (multiple ? 'multiple' : '') + ' accept="{{accept}}"/>' +
            ...
            element.on('change', function (onChangeEvent) {
                ...
                reader.onload = function (onLoadEvent) {
                    scope.$apply(function () {
                        ...
                        if (typeof (scope.result[0]) !== "undefined") {
                            Base.setColonnes(scope.result[0]);
                        }
